...
type MockedFn<T> = T extends (...args: infer A) => infer R
  ? jest.Mock<R, A>
  : T;
type Mocked<T> = { [K in keyof T]: MockedFn<T[K]> };
...
describe('AuthService — register', () => {
  ...
  let verificationTokenRepository: Mocked<Repository<VerificationToken>>;
...
describe('AuthService — login', () => {
  let authService: AuthService;
  let usersService: Mocked<UsersService>;
  let refreshTokenRepository: Mocked<Repository<RefreshToken>>;
